---
title: Pipeline d'evolution
description: Le 4-stage self-evolution pipeline in PRX -- gate, analyze, judge, execute.
---

# Evolution Pipeline

Every self-evolution proposal in PRX passes via un 4-stage pipeline: gate, analyze, judge, et execute. This pipeline garantit that changes are well-reasoned, safe, et reversible.
...
The gate stage determine whether an evolution cycle should trigger. It checks:
...
- Sanity checks against predefini dansvariants
- Risque assessment scoring
