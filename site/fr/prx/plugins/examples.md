---
title: Exemples de plugins
description: Example PRX plugins demonstrating common patterns and cas d'utilisations.
---
...
## Exemple 2: HTTP API Tool

A tool plugin that fetches data depuis unn external API:
...
## Exemple 4: Plugin with Configuration
