---
title: Flux OAuth2
description: OAuth2 authentication flows pris en charge par PRX for LLM provider authorization.
---

# OAuth2 Flows

PRX implemente OAuth2 authorization flows for fournisseurs that support browser-based authentication. This allows users to authenticate without manuellement managing API keys.
...
1. PRX opens a browser to le fournisseur's authorization URL
...
1. PRX requests a device code from le fournisseur
...
PRX automatiquement handles:

- Token caching pour eviter repeated authorization
