...
| გასაღები | ტიპი | ნაგულისხმევი | აღწერა |
|-----|------|---------|-------------|
| `update_server_url` | `string` | `"https://update.prx-sd.dev/v1"` | სიგნატურების განახლების სერვერის URL. ძრავა `<url>/manifest.json`-ს ჩამოტვირთავს განახლებების სათვალთვალოდ. კერძო სარკის ან air-gapped განახლების სერვერის გამოსაყენებლად გადაწყვეთ. |
