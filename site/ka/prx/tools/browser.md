...
- [Web Search](/ka/prx/tools/web-search) -- search the web without browser automation
- [HTTP Request](/ka/prx/tools/http-request) -- programmatic HTTP requests to APIs
- [Shell Execution](/ka/prx/tools/shell) -- alternative for CLI-based web interactions (curl, wget)
- [Security Sandbox](/ka/prx/security/sandbox) -- process isolation for tool execution
- [Configuration Reference](/ka/prx/config/reference) -- `[browser]` configuration fields
