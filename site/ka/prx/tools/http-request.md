...
- [Web Search](/ka/prx/tools/web-search) -- search the web and fetch page content
- [Browser Tool](/ka/prx/tools/browser) -- full browser automation for web pages
- [MCP Integration](/ka/prx/tools/mcp) -- connect to external tools via MCP protocol
- [Configuration Reference](/ka/prx/config/reference) -- `[http_request]` configuration fields
- [Proxy Configuration](/ka/prx/config/reference#proxy) -- outbound proxy settings
