...
- [Channels Overview](/ka/prx/channels/) -- all 19 supported messaging platforms
- [Gateway](/ka/prx/gateway/) -- HTTP API and WebSocket architecture
- [Gateway HTTP API](/ka/prx/gateway/http-api) -- REST API endpoints
- [Gateway WebSocket](/ka/prx/gateway/websocket) -- real-time streaming
- [Rendering Tools (TTS)](/ka/prx/tools/media) -- text-to-speech for voice messages
