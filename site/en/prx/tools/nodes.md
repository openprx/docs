...
1. **Pairing**: A node is paired with a controller through a challenge-response handshake (see [Node Pairing](/en/prx/nodes/pairing))
...
Nodes must complete a pairing handshake before they can exchange tasks. Unpaired nodes are rejected at the connection level. See [Node Pairing](/en/prx/nodes/pairing) for the pairing protocol.
...
- [Remote Nodes](/en/prx/nodes/) -- node system architecture
- [Node Pairing](/en/prx/nodes/pairing) -- pairing protocol and certificate exchange
- [Communication Protocol](/en/prx/nodes/protocol) -- wire protocol details
- [Security Pairing](/en/prx/security/pairing) -- security model for device pairing
- [Sessions & Agents](/en/prx/tools/sessions) -- alternative for local multi-agent execution
