...
- [Shell Execution](/en/prx/tools/shell) -- command execution tool (alternative for binary files)
- [Memory Tools](/en/prx/tools/memory) -- controlled memory access with ACL
- [Policy Engine](/en/prx/security/policy-engine) -- path-based access control rules
- [Configuration Reference](/en/prx/config/reference) -- memory and security settings
