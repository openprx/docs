...
- [Browser Tool](/en/prx/tools/browser) -- full browser automation for JavaScript-heavy sites
- [Configuration Reference](/en/prx/config/reference) -- `[web_search]` and `[browser]` fields
- [Secrets Management](/en/prx/security/secrets) -- encrypted storage for API keys
