...
- [Sub-agents](/en/prx/agent/subagents) -- sub-agent architecture and spawning model
- [Agent Runtime](/en/prx/agent/runtime) -- agent execution architecture
- [Agent Loop](/en/prx/agent/loop) -- core execution cycle
- [Session Worker](/en/prx/agent/session-worker) -- process isolation for sessions
- [Configuration Reference](/en/prx/config/reference) -- agent and subagent settings
