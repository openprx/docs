...
- [Configuration Reference](/en/prx/config/reference) -- `[mcp]` and `[mcp.servers]` settings
- [Tools Overview](/en/prx/tools/) -- built-in tools and MCP integration overview
- [Security Sandbox](/en/prx/security/sandbox) -- sandbox for MCP server processes
- [Secrets Management](/en/prx/security/secrets) -- encrypted storage for MCP server credentials
- [Shell Execution](/en/prx/tools/shell) -- alternative for running tools via shell commands
