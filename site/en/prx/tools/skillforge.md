...
Skillforge integrates with PRX's [self-evolution pipeline](/en/prx/self-evolution/). When the agent identifies a capability gap, it can trigger a discovery run automatically -- scouting, evaluating, and (if approved) integrating a matching skill for the next turn.
...
- [Self-Evolution Pipeline](/en/prx/self-evolution/pipeline)
- [Security Policy Engine](/en/prx/security/policy-engine)
- [Runtime Backends](/en/prx/agent/runtime-backends)
- [MCP Integration](/en/prx/tools/mcp)
