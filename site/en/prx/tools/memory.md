...
- [Memory System](/en/prx/memory/) -- architecture and storage backends
- [Markdown Backend](/en/prx/memory/markdown) -- file-based memory storage
- [SQLite Backend](/en/prx/memory/sqlite) -- local database storage
- [PostgreSQL Backend](/en/prx/memory/postgres) -- remote database storage
- [Embeddings](/en/prx/memory/embeddings) -- vector search configuration
- [Memory Hygiene](/en/prx/memory/hygiene) -- automatic cleanup and archival
- [File Operations](/en/prx/tools/file-operations) -- ACL interaction with file_read
